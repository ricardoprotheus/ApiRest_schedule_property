...
from helpers.commons import ACCESS_LEVEL_CHOICES
...
class User(AbstractBaseUser):
    ...
    permission = models.CharField(verbose_name=_("Nivel de permissão do usuário"), choices=ACCESS_LEVEL_CHOICES, blank=True, null=True, max_length=100)
